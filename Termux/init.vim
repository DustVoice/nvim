...
nmap <leader>a :call AsciiDoctor()<CR>
...
function! TermuxOpenHTML()
	execute("!firefox " . expand('%:r') . ".html")
endfunction

function! TermuxOpenPdf()
	execute("!sumatrapdf " . expand('%:r') . ".pdf")
endfunction

function! TermuxOpenEpub()
	execute("!ebook-viewer " . expand('%:r') . ".epub")
endfunction

nmap <leader>oo :call TermuxOpenFile()<CR><CR>
nmap <leader>oh :call TermuxOpenHTML()<CR><CR>
nmap <leader>op :call TermuxOpenPdf()<CR><CR>
nmap <leader>oe :call TermuxOpenEpub()<CR><CR>
